...
PATH_TO_CKPT = '/Users/sheldon/pythonProjects/py3venv/kaggle/fruit-images/graph/frozen_inference_graph.pb'

# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = '/Users/sheldon/pythonProjects/py3venv/kaggle/labelmap.pbtxt'
