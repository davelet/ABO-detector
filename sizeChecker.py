...
# Directories
train_directory = './fruit-images/train' # It should contain the xml files with bounding boxes
test_directory = './fruit-images/test' # It should contain the xml files with bounding boxes
